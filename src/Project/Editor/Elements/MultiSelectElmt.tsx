...
function MultiSelectElmt({handleRemoveElmt, element, handleUpdateElmt}: MultiChoiceProps) {
    ...
    <>  
     <div className='MultiChoiceElmt EvalElmt'>
        <div className="ElmtTopBar">
          <h2 className="ElmtTitle">Multiple Select Question</h2>
...
export default MultiSelectElmt
